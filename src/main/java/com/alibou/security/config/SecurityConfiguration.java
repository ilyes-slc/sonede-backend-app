        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/releve/**").hasAnyRole(ADMIN.name(), MANAGER.name())
                                .requestMatchers(GET, "/api/v1/releve/**").hasAnyAuthority(ADMIN_READ.name(), MANAGER_READ.name())
                                .requestMatchers(POST, "/api/v1/releve/**").hasAuthority(ADMIN_CREATE.name())
                                .requestMatchers(PUT, "/api/v1/releve/**").hasAuthority(ADMIN_UPDATE.name())
                                .requestMatchers(DELETE, "/api/v1/releve/**").hasAuthority(ADMIN_DELETE.name())
